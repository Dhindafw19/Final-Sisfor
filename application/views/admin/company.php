                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                                                <a href='<?php echo base_url("db_company/tambah"); ?>' class="btn btn-primary"><i class="material-icons">&#xE147;</i> <span>Tambah Data</span></a>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">1</th>
                                        <td>12345</td>
                                        <td>PT Wijaya Karya Beton</td>
                                        <td>0861525242</td>
                                        <td>sgavdhs@gmail.com</td>
                                        <td>ahsuxuacus12</td>
                                        <td>
